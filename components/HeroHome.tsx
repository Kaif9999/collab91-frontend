...
export default function HeroHome() {
  return (
    <section className="relative w-full bg-white min-h-[600px] overflow-hidden">
      ...
      <div className="container mx-auto py-8 grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
        ...
        <div className="flex mx-2 flex-col -mt-6 lg:mt-6">
          ...
          <p className="mt-4 text-2xl text-[#00406E] leading-relaxed max-w-xl">
            ...
            <span className="bg-[#010080] text-white px-2 py-1 font-semibold">
              "sum of parts"
            </span>{" "}
          ...
          <div className="flex flex-wrap gap-4 mt-4 w-[80%]">
            {/* LEARN MORE Button */}
            <button 
        ...
        <div className="relative w-full h-full min-h-[400px] flex items-center justify-center mt-4 lg:mt-6">
          <Image src="/herosection.svg" alt="Hero Home" width={794} height={554} className="w-full h-full" />
        </div>
      </div>
      <div className="relative min-h-[299px] min-w-[678px] lg:min-h-[149px] w-full lg:min-w-[321px]">
            <Image src="/blue-bg.svg" alt="Blue Background" width={321} height={149} />
      </div>
    </section>
  );
}
